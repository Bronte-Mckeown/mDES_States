...
setwd("C:\\Users\\bront\\Documents\\CanadaPostdoc\\GradientSpace\\results\\scientificreports\\lmm_thought_maps")

results_dir <- "C:\\Users\\bront\\Documents\\CanadaPostdoc\\GradientSpace\\results\\scientificreports\\lmm_thought_maps"
...
ggsave(
  "LMM_avgRun_compare_all_maps_grad3.tiff",
  bar3, units = "cm",
  width = 5,
  height = 3,
  dpi = 1000, 
